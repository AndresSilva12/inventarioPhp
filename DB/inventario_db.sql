...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2024 a las 17:27:09
...
(3, 'categoria1', 'ala Sur'),
(4, 'categoria2', 'ala Norte'),
(5, 'categoria3', 'ala Superior');
...
CREATE TABLE `usuario` (
  ...
  `usuario_rol` enum('admin','cliente') NOT NULL DEFAULT 'cliente'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
(22, 'andres', 'silva', 'androide', '$2y$10$IRMdWwNlYdcfBw8qvXSWvuk72gMoT9I8QcPggWtAT/yiYLEd2QTca', 'andres.silva4120@gmail.com', 'cliente'),
(31, 'andres', 'panico', 'panico12', '$2y$10$s24N10J9fF84PbqWR4w6LeUTdOcp4jT.AQnRBpytvSFZqZVTDjW06', 'panico12ans@gmail.com', 'admin'),
(32, 'dfgfgk', 'sfdgjfd', 'sdfjnsdfj1234', '$2y$10$8NQDrEE3mEeTX/S9EmNj2.jdyTmzI.VT1D1GSLmrYBeagJBFEtDvq', 'sdfjnsdfj1234@gmail.com', 'admin');
